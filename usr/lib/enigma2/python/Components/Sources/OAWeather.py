...
class OAWeather(Source):
    ...
    def __init__(self):
        ...
        self.enabledebug = config.plugins.OAWeather.debug.value if hasattr(config.plugins, 'OAWeather') else False
        ...
        self.logo = self.services.get(config.plugins.OAWeather.weatherservice.value, "msn") if hasattr(config.plugins, 'OAWeather') else "msn"
